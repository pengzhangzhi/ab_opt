...
from .sabdab import _label_heavy_chain_cdr, _label_light_chain_cdr, _label_whole_chain_as_cdr
from ._base import register_dataset


def preprocess_antibody_structure(task,label_whole_heavy_chain_as_cdr=False):
    ...
    try:
        if H_id in all_chain_ids:
            label_fn = _label_whole_chain_as_cdr if label_whole_heavy_chain_as_cdr else _label_heavy_chain_cdr
            (
                parsed['heavy'], 
                parsed['heavy_seqmap']
            ) = label_fn(*parsers.parse_biopython_structure(
                model[H_id],
